                    ...
                    <div class="box register">
                        ...
                        <form name="Sign_up" class="form-actions" action="register_s.php" method="post" onSubmit="return validateForm(this);">
							...
							<div class="form-group">
                                ...
                                <input type="text" class="form-control" id="user" name="user" placeholder="Phone">
								<code id="div_User_NameError">
								  <?php
								  if (array_key_exists('user', $Errors))
								  {
                            ...
                            <div class="text-center">
                                <button type="submit" name="submit_button" class="btn btn-primary login" ><i class="fa fa-user-md"></i> Register</button>
                            </div>
                        </form>
						<br>
						<br>
						<div class="newtosite2">
