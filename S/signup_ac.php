...
$sql="INSERT INTO temp_members (confirm_code, name, email, password, country)VALUES('$confirm_code', '$name', '$email', '$password', '$country')";
...
$mail->Body = "<h1>Order Confirmation</h1>
    <div align=\"center\">
		<p>Your Comfirmation link </p>
		 <p>http://localhost/confirmation.php?passkey=$confirm_code</p>
	</div>";
