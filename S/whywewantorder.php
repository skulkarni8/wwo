...
<body>
    ...
    <div id="all">
        ...
        <div id="content">
            <div class="container">
               <div class="col-md-6" style="float:none; background-color:#fff; margin:auto auto; padding:0px;">
				...
				<div class="col-md-4">
                    <div class="box login">
                        ...
                        <form action="user-man.php" method="post">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary login"><i class="fa fa-sign-in"></i> Change Password</button>
                            </div>
                        </form>
                    </div>
                </div>-->
